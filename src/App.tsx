...
// import { WidgetWrapper, SelectContainer, PoolInfo, ButtonContainer, BottomLargeMargin, BottomSmallMargin, StyledLink} from './components/styleComponents';
...
const App: React.FC = () => {
  ...
  // should have made two for each zap and pool components
  ...
  //   //added because of error 'selectedPool Object might be undefined'
  //   if (!selectedPool){
  //     return (<div></div>)
  //   }
  //   return(
